...
double ratio = x1/y1;
FILE * fp1 = fopen("DepolTotalXF.txt", "r"); // epsilon factor

FILE *fp2 = fopen("ALUTotalXF.txt", "r"); //A_LU

FILE *fp4 = fopen("FLU_XF_Tab.txt", "w"); //F_LU
int n=0;
...
////////////////////////////////////////////////////////////////////////////////
FILE *fp3 = fopen("ALUTotalXF.txt", "r");
int o = 0;
...
h3->GetYaxis()->SetRangeUser(-0.04, 0.05); //xF (-0.04, 0.04); Q2 (-0.05, 0.005); pT_TFR (-0.09, 0.0); pT_CFR (-0.02, 0.17)
